...
//#region node_modules/.pnpm/nuxt@4.5.2_@babel+plugin-sy_13df6f7b920c11ae9cc702760e2a0bbe/node_modules/nuxt/dist/app/components/error-500.vue
var _sfc_main = {
	__name: "error-500",
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-[#020420] dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-[#020420] tracking-wide" }, _attrs))} data-v-e575177e><div class="max-w-520px text-center" data-v-e575177e><h1 class="font-semibold leading-none mb-4 sm:text-[110px] tabular-nums text-[80px]" data-v-e575177e>${ssrInterpolate(__props.status)}</h1><h2 class="font-semibold mb-2 sm:text-3xl text-2xl" data-v-e575177e>${ssrInterpolate(__props.statusText)}</h2><p class="mb-4 px-2 text-[#64748B] text-md" data-v-e575177e>${ssrInterpolate(__props.description)}</p></div></div>`);
		};
	}
};
...
_sfc_main.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.5.2_@babel+plugin-sy_13df6f7b920c11ae9cc702760e2a0bbe/node_modules/nuxt/dist/app/components/error-500.vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var error_500_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-e575177e"]]);

export { error_500_default as default };
//# sourceMappingURL=error-500-BuGQ3thC.mjs.map
